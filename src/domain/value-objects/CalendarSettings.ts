export class CalendarSettings {
  ...
  public readonly style: 'modern-grid' | 'modern-weekly' | 'classic' | 'calendar-1' | 'calendar-2' | 'calendar-3' | 'calendar-4' | 'calendar-5' | 'calendar-6' | 'calendar-7' | 'calendar-8' | 'calendar-9' | 'calendar-10' | 'calendar-11' | 'modern-grid-zoom' | 'modern-grid-zoom-fixed';
