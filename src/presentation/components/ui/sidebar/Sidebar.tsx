...
const WIDGET_CATEGORIES = {
  calendar: {
    ...
    styles: [
      ...
      { label: '1 — Scale Transform', value: 'calendar-1', color: '#e74c3c' },
      { label: '2 — CSS Zoom', value: 'calendar-2', color: '#e67e22' },
      { label: '3 — Fluid Responsive', value: 'calendar-3', color: '#2ecc71' },
      { label: '4 — Container Query', value: 'calendar-4', color: '#3498db' },
      { label: '5 — Fixed + Scroll', value: 'calendar-5', color: '#9b59b6' },
      { label: '6 — SVG ViewBox', value: 'calendar-6', color: '#1abc9c' },
      { label: '7 — Viewport Units', value: 'calendar-7', color: '#f39c12' },
      { label: '8 — Aspect Ratio', value: 'calendar-8', color: '#e84393' },
      { label: '9 — Grid Auto-fit', value: 'calendar-9', color: '#00cec9' },
      { label: '10 — PostMessage', value: 'calendar-10', color: '#6c5ce7' },
      { label: '11 — Pure SVG (WidgetBox)', value: 'calendar-11', color: '#2d3436' },
    ],
  },
  clock: {
    label: 'Clock',
